                ...
                <Card>
                    <Flex justifyContent="space-between">
                        <Box>
                            ...
                            <Text>
                                Je maakt nog geen onderdeel uit van een{' '}
                                <strong>{type}</strong>.{' '}
                            </Text>

                            <Text mt={4}>
                                Om onderdeel van een <strong>{type}</strong> te
                                worden moet je of een uitnodiging accepteren of
                                je eigen team bij een club starten
                            </Text>
                            ...
                            {invitationToken && (
                                <Text
                                    ...
                                    fontStyle="italic"
                                >
                                    Je hebt op dit moment 1 open uitnodiging
                                    staan voor een team.
                                </Text>
                            )}
                            <Flex mt={4}>
