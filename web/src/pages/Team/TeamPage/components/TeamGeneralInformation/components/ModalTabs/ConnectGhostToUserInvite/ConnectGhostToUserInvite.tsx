    ...
    return (
        <ValidateTeamInvitation team={team}>
            <TextAlert status="info">
                <Text>
                    <strong>Ghost spelers</strong> kunnen gekoppeld worden aan
                    echte spelers van je team. De unieke uitnodiging zorgt
                    ervoor dat alle punten en statistieken worden overgenomen
                    bij het aanmelden van het account.
                </Text>
            </TextAlert>
            ...
            <Box mt={4}>
                {ghostPlayers && ghostPlayers.length > 0 ? (
                    ...
                    <Text>
                        Er zijn geen ghost spelers gevonden. Maak eerst
                        ghostspelers aan via
                        <Button
                            variant="link"
                            textDecor="underline"
