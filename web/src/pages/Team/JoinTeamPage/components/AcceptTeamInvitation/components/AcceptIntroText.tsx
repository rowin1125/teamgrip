    ...
    return (
        <>
            ...
            <Text mt={8} color="white">
                ...
                {team?.club?.name}. Join en maak deel uit van dit fantastische
                team en ga de uitdaging aan.
            </Text>
            {hasGhostPlayer && (
                <Box mt={8}>
                    <Text color="white" mb={4}>
                        Deze uitnodiging is een unieke uitnoding omdat deze
                        gekoppeld is aan een bestaande speler van {team?.name}
                    </Text>
                    <TextAlert status="warning" color="primary.500">
                        <Text>
                            Je gaat als je op <u>join als</u> drukt gekoppeld
                            worden aan: <br />-{' '}
                            <strong>{ghostPlayer.displayName}</strong>
                        </Text>
                    </TextAlert>
                </Box>
            )}
            <Text mt={8} fontSize="sm" fontStyle="italic" color="white">
                Indien je geen idee hebt waarom je bent uitgenodigd kan je
                altijd weigeren
            </Text>
        </>
    );
