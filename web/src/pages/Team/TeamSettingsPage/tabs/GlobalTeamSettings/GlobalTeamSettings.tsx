...
const GlobalTeamSettings = () => {
    ...
    return (
        <>
            ...
            <DefaultLoader minH="600px" isLoading={loading}>
                <Box my={8} w={{ base: '100%', xl: '500px' }}>
                    ...
                    <DataDisplay
                        ...
                        entry={{
                            ...
                            'Open uitnodiging': team?.invitationToken
                                ? 'Ja'
                                : 'Nee',
                ...
                >
                    ...
                    <Text mt={4}>
                        Verwijder het team permanent. Dit kan niet ongedaan
                        worden en betekend dat alle data permanent verloren
                        gaat. Daarnaast komt de teamnaam vrij voor andere teams
                        om te gebruiken en worden alle spelers losgekoppeld van
                        het team.
                    </Text>
                    {team && (
                        <DeleteDialog
