...
const NewSeasonPage = () => {
    ...
    return (
        <>
            <MetaTags
                title="Nieuw seizoen"
                description="Start een nieuw seizoen"
            />
                ...
                <GridItem colSpan={{ base: 3, xl: 2 }}>
                    <Card>
                        ...
                        <TextAlert my={8} status="info">
                            <Text>
                                Alle gegeven worden opgeslagen aan de hand van
                                een <strong>seizoen</strong>. Let dus goed op
                                dat je maar 1 seizoen actief hebt staan.
                            </Text>
                        </TextAlert>
                        <DefaultLoader
