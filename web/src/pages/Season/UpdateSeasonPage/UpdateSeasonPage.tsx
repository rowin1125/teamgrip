...
const UpdateSeasonPage = () => {
    ...
    return (
        <>
            <MetaTags
                title="Update jouw seizoen"
                description="UpdateSeason page"
            />
                ...
                <GridItem colSpan={{ base: 3, xl: 2 }}>
                    <Card>
                        ...
                        <TextAlert my={8} status="warning">
                            <Text>
                                Alle score / trainingen / wedstrijd die aan dit
                                seizoen zullen overgezet worden naar het nieuwe
                                seizoen. Let dus goed op!
                            </Text>
                        </TextAlert>
                        <DefaultLoader
                            isLoading={seasonLoading || loading}
                            minH="200px"
                        >
